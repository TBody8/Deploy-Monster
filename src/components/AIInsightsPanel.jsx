...
const AIInsightsPanel = memo(
  ({ consumptionData, currentLevel, isVisible = true }) => {
    ...
    return (
      <AnimatePresence>
        <motion.div
          className='bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-2xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300'
